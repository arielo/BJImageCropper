...
- (void)updateBounds {
  ...
  topRightView.frame = CGRectMake(x + width + 1, -1, selfWidth - x - width, y + 1);
  ...
  CGFloat cWidth = 26.0f;
  
  corner_right_top.frame = CGRectMake(corner_right_top.frame.origin.x,
                                      CGRectGetMinY(cropView.frame),
                                      cWidth,
                                      cWidth);
  
  corner_left_bottom.frame = CGRectMake(cropView.frame.origin.x,
                                        corner_left_bottom.frame.origin.y,
                                        cWidth,
                                        cWidth);
  
  corner_left_top.frame = CGRectMake(cropView.frame.origin.x,
                                     CGRectGetMinY(cropView.frame),
                                     cWidth,
                                     cWidth);
...
+ (UIView *)initialCropViewForImageView:(UIImageView*)imageView {
  ...
  CGFloat height = width;//CGHeight(max) / 4 * 3;
...
- (void)setup {
  ...
  // Top Right Corner
  corner_right_top = [[UIImageView alloc] initWithFrame:CGRectMake(CGWidth(topRightView.frame)-26, 0, 26, 26)];
  corner_right_top.image = [UIImage imageNamed:@"crop_corner_right_top"];
  [topRightView addSubview:corner_right_top];
  
  // Bottom Right Corner
  corner_right_bottom = [[UIImageView alloc] initWithFrame:CGRectMake(CGWidth(bottomRightView.frame)-26, -26, 26, 26)];
  corner_right_bottom.image = [UIImage imageNamed:@"crop_corner_right_bottom"];
  [bottomRightView addSubview:corner_right_bottom];
  
  // Top Left Corner
  corner_left_top = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 26, 26)];
  corner_left_top.image = [UIImage imageNamed:@"crop_corner_left_top"];
  [topLeftView addSubview:corner_left_top];
  
  // Bottom Left Corner
  corner_left_bottom = [[UIImageView alloc] initWithFrame:CGRectMake(0, -26, 26, 26)];
  corner_left_bottom.image = [UIImage imageNamed:@"crop_corner_left_bottom"];
  [bottomLeftView addSubview:corner_left_bottom];
